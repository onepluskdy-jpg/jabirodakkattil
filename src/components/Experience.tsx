...
const experiences = [{
  type: "work",
  title: "Graphic Designer cum Laser Cutting Machine Operator",
  company: "PRIX Creative Hub",
  location: "Kondotty",
  period: "2024 – Present",
  description: "Leading design projects for diverse clients while managing laser cutting operations for precision signage and promotional materials."
}, {
  type: "work",
  title: "Graphic Designer cum Laser Cutting Machine Operator",
  ...
  location: "Kozhikode",
  period: "2023 – 2024",
  description: "Created visual designs for branding and advertising while handling print production and machine operations."
}];
const education = [{
          ...
          <div>
            ...
            <div className="space-y-6">
              {education.map((edu, index) => <div key={index} className="glass-card rounded-2xl p-6 hover-lift relative overflow-hidden group">
                  <div className="absolute top-0 left-0 w-1 h-full bg-primary/50 group-hover:bg-primary transition-colors" />
                  <h4 className="text-xl font-semibold mb-1 text-foreground font-sans">
                    {edu.title}
                  </h4>
                  <p className="text-primary font-body text-sm font-medium mb-3">
                    {edu.institution}
                  </p>
                  <p className="text-muted-foreground font-body text-sm leading-relaxed">
                    {edu.description}
