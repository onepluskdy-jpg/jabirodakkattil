...
const education = [
  {
    title: "Diploma — Visualizing & Corporate Advertising",
...
const Experience = () => {
  return (
    <section id="experience" className="py-24 md:py-32 px-6 md:px-12 border-t border-border">
          ...
          <div className="lg:col-span-9">
            ...
            <div className="mb-20">
              ...
              <ul className="divide-y divide-border border-y border-border">
                {experiences.map((exp) => (
                  <li key={exp.company} className="py-6 grid md:grid-cols-12 gap-4 items-baseline">
            ...
            <div>
              ...
              <ul className="divide-y divide-border border-y border-border">
                {education.map((edu) => (
                  <li key={edu.title} className="py-6 grid md:grid-cols-12 gap-4 items-baseline">
                    <span className="md:col-span-3 font-body text-sm text-muted-foreground">
                      {edu.period}
                    </span>
                    <span className="md:col-span-5 font-display font-medium text-xl md:text-2xl text-foreground">
